...
LENGTH <- c("Shape_Leng") #wchydro is LLID   SHORTENED FOR DBF
library(RODBC)
#cnn1 <- odbcConnectAccess("C:\\data\\ProjectsLocal\\Segments\\traceTest\\sea_temp.mdb")
...
nodes.dbf<- read.dbf("C:\\data\\ProjectsLocal\\Segments\\traceTest\\junctions.dbf")
edges.dbf <- read.dbf("C:\\data\\ProjectsLocal\\Segments\\traceTest\\edges.dbf")
