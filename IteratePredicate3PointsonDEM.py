...
myPoints = "C:\data\projectslocal\pointsholder.mdb\junctions915"
...
outTable = "C:\\data\\projectslocal\segments\\DEMpoints_" + str(n) + "_.txt"
...
#Iterated function
    gp.Sample_sa(myRaster, "targ_lay", outTable, "BILINEAR")
